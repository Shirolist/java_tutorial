...
public class PromptRecipientAccountNumberView extends JPanel implements IView, ActionListener
{
    ...
    public PromptRecipientAccountNumberView( InputHandler inputHandler )
    {
        ...
        accountNumberLabel = new JLabel( "Enter the recipient's account number:", SwingConstants.CENTER );
    ...
    public void actionPerformed( ActionEvent actionEvent )
    {
        if ( actionEvent.getSource() == accountNumberField ) {
            ...
            inputHandler.setSignal( InputHandler.Signal.PROMPT_TRANSFER_RECIPIENTS_ACCOUNT_NUMBER );
        }
    }
}