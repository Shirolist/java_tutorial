...
public class TakeYourCashView extends JPanel implements IView
{
    private boolean isTaken;
    private final InputHandler inputHandler;

    public TakeYourCashView( InputHandler inputHandler )
    {
        ...
        JLabel instructionLabel = new JLabel( "Take your cash.", SwingConstants.CENTER );
        instructionLabel.setFont( font );
        constraints.gridx = 0;
        constraints.gridy = 0;
        content.add( instructionLabel, constraints );

        JLabel tipLabel = new JLabel( "Press enter to simulate take cash action.", SwingConstants.CENTER );
    ...
    class ResponseListener implements KeyListener
    {
        ...
        public void keyPressed( KeyEvent keyEvent )
        {
            if ( keyEvent.getKeyCode() == KeyEvent.VK_ENTER ){
                ...
                inputHandler.setSignal( InputHandler.Signal.TAKE_CASH );
            }
        }
